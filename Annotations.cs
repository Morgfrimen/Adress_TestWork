...
namespace Adress_TestWork.Annotations
{
    /// <summary>
    ...
    (
        ...
        | AttributeTargets.Method | AttributeTargets.Delegate, AllowMultiple = true
    )]
    ...
    [AttributeUsage
    (
        AttributeTargets.Parameter | AttributeTargets.Method | AttributeTargets.Field
